...
(function ($) {
	...
	var loadFamax = function() {
		...
		$('#famax').append('<div id="famax-encloser">'+famaxColumnsHTML+'<div class="load-more-wrapper"><span class="load-more" id="load-more">Mehr</span></div></div>');

		$('#load-more').click(function(){
			$('#load-more').text('laden..');
			loadMore();
		});
	...
	showInfo = function(response) {
		...
		$('#famax-header').append('<a target="_blank" href="'+pageLink+'"><img  src="'+pagePic+'"/>'+pageName+'</a>&nbsp;&nbsp;&nbsp;');

		$('#famax-header').append('<div class="famax-like-wrapper"><iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2F'+pageId+'&amp;send=false&amp;layout=box_count&amp;width=200&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=90&amp;appId=384323531651193" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:70px;" allowTransparency="true"></iframe></div>');
